...
const BUILTIN_RULES: Array<{
  ...
  },
  {
    ...
    patterns: [/de\s+friesland/, /zorgverzekeraar/, /\bzorgverzekering\b/],
    fixedCostHint: true,
    essentialHint: true,
  },
  {
  ...
  },
  {
    ...
    patterns: [/\bspotify\b/, /\bnetflix\b/, /\bvideoland\b/, /\bdisney\b/, /\bprime video\b/, /\bprime\b/],
  ...
  },
  {
    ...
    patterns: [/\bgithub\b/, /\bopenai\b/, /\bchatgpt\b/, /\bgoogle workspace\b/, /\bmicrosoft 365\b/, /\badobe\b/, /\bfigma\b/, /\bnotion\b/],
    subscriptionHint: true,
  },
]

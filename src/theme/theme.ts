...
export const appTheme = createTheme({
  ...
  typography: {
    ...
    h1: { fontSize: 30, lineHeight: '38px', letterSpacing: 0, fontWeight: 800 },
    h2: { fontSize: 24, lineHeight: '32px', letterSpacing: 0, fontWeight: 750 },
    h3: { fontSize: 20, lineHeight: '28px', letterSpacing: 0, fontWeight: 700 },
    h4: { fontSize: 17, lineHeight: '26px', letterSpacing: 0, fontWeight: 700 },
